...
namespace Marketplace.App.Migrations
{
    ...
    [Migration("20180902171842_many-to-many")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marketplace.App.DataBase.Entities.MarketProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Marketplace.App.DataBase.Entities.MarketProduct", b =>
                {
                    b.HasOne("Marketplace.App.DataBase.Entities.Market", "Market")
                        .WithMany("Products")
                        .HasForeignKey("MarketId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Marketplace.App.DataBase.Entities.Product", "Product")
                        .WithMany("InMarkets")
